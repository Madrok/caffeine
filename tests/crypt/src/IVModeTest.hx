...
class IVModeTest extends TestCase {
	...
	function aes_common(key : Bytes, bits : Int, mode, iv : Bytes, pt : Bytes,
			ct : Bytes) : Cipher {
		...
		var num = cipher.finalize(pt, 0, pt.length, out);
		var crypted = out.getBytes();
		assertEquals(ct.toHex(), crypted.toHex());

		cipher.init(DECRYPT, p);
		out = new BytesOutput();
		num = cipher.finalize(crypted, 0, crypted.length, out);
	...
	public function testStepped() : Void {
		...
		var pt : Bytes = Bytes.ofHex("6bc1bee22e409f96e93d7e117393172a"
			+ "ae2d8a571e03ac9c9eb76fac45af8e51");
		var ct : Bytes = Bytes.ofHex("7649abac8119b246cee98e9b12e9197d"
		...
		assertEquals(13, num);
		num = cipher.finalize(pt, 18, pt.length - 18, out);
		assertEquals(14, num);
		var crypted = out.getBytes();
		assertEquals(ct.toHex(), crypted.toHex());
	...
	public function testCBC_AES192() : Void {
		...
		var pt : Bytes = Bytes.ofHex("6bc1bee22e409f96e93d7e117393172a"
			+ "ae2d8a571e03ac9c9eb76fac45af8e51" + "30c81c46a35ce411e5fbc1191a0a52ef"
			+ "f69f2445df4f9b17ad2b417be66c3710");
		var ct : Bytes = Bytes.ofHex("4f021db243bc633d7178183a9fa071e8"
	...
	public function testCBC_AES256() : Void {
		trace("\n============== CBC AES 256 ==========\n");
		var key : Bytes = Bytes.ofHex("603deb1015ca71be2b73aef0857d7781"
			+ "1f352c073b6108d72d9810a30914dff4");
		var iv = Bytes.ofHex("000102030405060708090a0b0c0d0e0f");
		var pt : Bytes = Bytes.ofHex("6bc1bee22e409f96e93d7e117393172a"
			+ "ae2d8a571e03ac9c9eb76fac45af8e51" + "30c81c46a35ce411e5fbc1191a0a52ef"
			+ "f69f2445df4f9b17ad2b417be66c3710");
		var ct : Bytes = Bytes.ofHex("f58c4c04d6e5f1ba779eabfb5f7bfbd6"
	...
	public function testOFB_AES128() : Void {
		...
		var pt : Bytes = Bytes.ofHex("6bc1bee22e409f96e93d7e117393172a"
			+ "ae2d8a571e03ac9c9eb76fac45af8e51" + "30c81c46a35ce411e5fbc1191a0a52ef"
			+ "f69f2445df4f9b17ad2b417be66c3710");
		var ct : Bytes = Bytes.ofHex("3b3fd92eb72dad20333449f8e83cfb4a"
			+ "7789508d16918f03f53c52dac54ed825" + "9740051e9c5fecf64344f7a82260edcc"
	...
	public function testCFB8_AES128() : Void {
		...
		var key : Bytes = Bytes.ofHex("2b7e151628aed2a6abf7158809cf4f3c");
		var iv = Bytes.ofHex("000102030405060708090a0b0c0d0e0f");
		var pt : Bytes = Bytes.ofHex("6bc1bee22e409f96e93d7e117393172a" + "ae2d");
		var ct : Bytes = Bytes.ofHex("3b79424c9c0dd436bace9e0ed4586a4f" + "32b9");
	...
	**/
	public function testCTR_AES128() : Void {
		...
		var c = aesctr128(key, 128, iv, "6bc1bee22e409f96e93d7e117393172a",
			"874d6191b620e3261bef6864990db6ce");
		c = aesctr128(key, 128, c.getCurrentIV(), "ae2d8a571e03ac9c9eb76fac45af8e51",
	...
	public function testCTR_AES192() : Void {
		...
		var c = aesctr128(key, 192, iv, "6bc1bee22e409f96e93d7e117393172a",
			"1abc932417521ca24f2b0459fe7e6e0b");
		c = aesctr128(key, 192, c.getCurrentIV(), "ae2d8a571e03ac9c9eb76fac45af8e51",
