...
class RsaTest extends haxe.unit.TestCase {
	public static function main() {
		...
		trace(rsa
			.encrypt(Bytes.ofString("message"))
			.toHex()
		);
	}
	...
	function testSigning() {
		...
		var rsa = new RSA();
		// rsa.setPrivate(RSAK3.modulus, RSAK3.publicExponent, RSAK3.privateExponent);
		rsa.setPrivateEx(RSAK2.modulus, RSAK2.publicExponent, RSAK2.privateExponent, RSAK2.prime1,
			RSAK2.prime2, RSAK2.exponent1, RSAK2.exponent2, RSAK2.coefficient);
		// rsa.setPrivateEx(RSAK3.modulus, RSAK3.publicExponent, RSAK3.privateExponent,
	...
	function testSpeed() {
		...
		rsa.setPrivateEx(RSAK3.modulus, RSAK3.publicExponent, RSAK3.privateExponent, RSAK3.prime1,
			RSAK3.prime2, null, null, RSAK3.coefficient);
