...
class X509 extends haxe.unit.TestCase {
	...
	function testEmails() {
		...
		assertEquals(0, verisign
			.getEmails()
			.length
		);
		assertEquals(0, thawte
			.getEmails()
			.length
		);
	}
	...
	function testNotAfter() {
		assertEquals("2013-03-05 09:32:14", cacert1
			.getNotAfter()
			.toString()
		);
	}
...
class Certs {
	static public var CaKeyPem : String = "-----BEGIN RSA PRIVATE KEY-----
...
-----END RSA PRIVATE KEY-----";
	...
	static public var CaCertPem : String = "-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----";
	...
	// MD2
	static public var Verisign : String = "-----BEGIN CERTIFICATE-----\n"
	...
	static public var Thawte : String = "-----BEGIN CERTIFICATE-----\n"
