...
class MozillaRootCertificates extends X509CertificateCollection {
	public function new() {
		super();
		super.addPEMCertificate("Verisign/RSA Secure Server CA", // X500 Subject, for lookups.
			...
			+ "-----END CERTIFICATE-----");
		super.addPEMCertificate("GTE CyberTrust Root CA", // X500 Subject, for lookups.
		...
		super.addPEMCertificate("GTE CyberTrust Global Root", // X500 Subject, for lookups.
		...
		super.addPEMCertificate("Thawte Personal Basic CA", // X500 Subject, for lookups.
			...
			"-----END CERTIFICATE-----");
		super.addPEMCertificate("Thawte Personal Premium CA", // X500 Subject, for lookups.
			...
			+ "-----END CERTIFICATE-----");
		super.addPEMCertificate("Thawte Personal Freemail CA", // X500 Subject, for lookups.
			...
			+ "-----END CERTIFICATE-----");
		super.addPEMCertificate("Thawte Server CA", // X500 Subject, for lookups.
		...
		super.addPEMCertificate("Thawte Premium Server CA", // X500 Subject, for lookups.
			...
			+ "-----END CERTIFICATE-----");
		super.addPEMCertificate("Equifax Secure CA", // X500 Subject, for lookups.
		...
		super.addPEMCertificate("Verisign Class 4 Public Primary Certification Authority - G2",
			...
			+ "-----END CERTIFICATE-----");
		super.addPEMCertificate("GlobalSign Root CA", // X500 Subject, for lookups.
		...
		super.addPEMCertificate("GlobalSign Root CA - R2", // X500 Subject, for lookups.
			...
			+ "-----END CERTIFICATE-----");
		super.addPEMCertificate("ValiCert Class 1 VA", // X500 Subject, for lookups.
		...
		super.addPEMCertificate("ValiCert Class 2 VA", // X500 Subject, for lookups.
			"MIG7MSQwIgYDVQQHExtWYWxpQ2VydCBWYWxpZGF0aW9uIE5ldHdvcmsxFzAVBgNVBAoTDlZhbGlD"
		...
		super.addPEMCertificate("RSA Root Certificate 1", // X500 Subject, for lookups.
			"MIG7MSQwIgYDVQQHExtWYWxpQ2VydCBWYWxpZGF0aW9uIE5ldHdvcmsxFzAVBgNVBAoTDlZhbGlD"
		...
		super.addPEMCertificate("Verisign Class 4 Public Primary Certification Authority - G3",
			...
			+ "-----END CERTIFICATE-----");
		super.addPEMCertificate("Entrust.net Secure Server CA", // X500 Subject, for lookups.
			...
			+ "-----END CERTIFICATE-----");
		super.addPEMCertificate("Entrust.net Secure Personal CA", // X500 Subject, for lookups.
		...
		super.addPEMCertificate("Baltimore CyberTrust Root", // X500 Subject, for lookups.
		...
		super.addPEMCertificate("Equifax Secure Global eBusiness CA", // X500 Subject, for lookups.
		...
		super.addPEMCertificate("Equifax Secure eBusiness CA 1", // X500 Subject, for lookups.
		...
		super.addPEMCertificate("Equifax Secure eBusiness CA 2", // X500 Subject, for lookups.
		...
		super.addPEMCertificate("Visa International Global Root 2", // X500 Subject, for lookups.
		...
		super.addPEMCertificate("beTRUSTed Root CA", // X500 Subject, for lookups.
		...
		super.addPEMCertificate("AddTrust Low-Value Services Root", // X500 Subject, for lookups.
			...
			+ "-----END CERTIFICATE-----");
		super.addPEMCertificate("AddTrust External Root", // X500 Subject, for lookups.
		...
		super.addPEMCertificate("AddTrust Public Services Root", // X500 Subject, for lookups.
		...
		super.addPEMCertificate("Thawte Time Stamping CA", // X500 Subject, for lookups.
		...
		super.addPEMCertificate("beTRUSTed Root CA - RSA Implementation",
			...
			+ "-----END CERTIFICATE-----");
		super.addPEMCertificate("RSA Security 2048 v3", // X500 Subject, for lookups.
			...
			+ "-----END CERTIFICATE-----");
		super.addPEMCertificate("RSA Security 1024 v3", // X500 Subject, for lookups.
		...
		super.addPEMCertificate("GeoTrust Global CA", // X500 Subject, for lookups.
			...
			+ "-----END CERTIFICATE-----");
		super.addPEMCertificate("GeoTrust Global CA 2", // X500 Subject, for lookups.
			...
			+ "4iIprn2DQKi6bA==\n" + "-----END CERTIFICATE-----");
		super.addPEMCertificate("GeoTrust Universal CA", // X500 Subject, for lookups.
			...
			+ "-----END CERTIFICATE-----");
		super.addPEMCertificate("GeoTrust Universal CA 2", // X500 Subject, for lookups.
		...
		super.addPEMCertificate("America Online Root Certification Authority 2",
			...
			+ "RY8mkaKO/qk=\n" + "-----END CERTIFICATE-----");
		super.addPEMCertificate("Visa eCommerce Root", // X500 Subject, for lookups.
		...
		super.addPEMCertificate("TC TrustCenter, Germany, Class 3 CA",
			...
			+ "-----END CERTIFICATE-----");
		super.addPEMCertificate("Certum Root CA", // X500 Subject, for lookups.
		...
		super.addPEMCertificate("Comodo AAA Services root", // X500 Subject, for lookups.
		...
		super.addPEMCertificate("Comodo Secure Services root", // X500 Subject, for lookups.
		...
		super.addPEMCertificate("Comodo Trusted Services root", // X500 Subject, for lookups.
			...
			"-----END CERTIFICATE-----");
		super.addPEMCertificate("IPS Chained CAs root", // X500 Subject, for lookups.
		...
		super.addPEMCertificate("IPS CLASE1 root", // X500 Subject, for lookups.
			...
			+ "hjM+5i9Ibq9UkE6tsSU=\n" + "-----END CERTIFICATE-----");
		super.addPEMCertificate("IPS CLASE3 root", // X500 Subject, for lookups.
			"MIIBEjELMAkGA1UEBhMCRVMxEjAQBgNVBAgTCUJhcmNlbG9uYTESMBAGA1UEBxMJQmFyY2Vsb25h"
			+ "MS4wLAYDVQQKEyVJUFMgSW50ZXJuZXQgcHVibGlzaGluZyBTZXJ2aWNlcyBzLmwuMSswKQYDVQQK"
			+ "FCJpcHNAbWFpbC5pcHMuZXMgQy5JLkYuICBCLTYwOTI5NDUyMS4wLAYDVQQLEyVJUFMgQ0EgQ0xB"
			...
			+ "r33I6unUVtkOE7LFRVA=\n" + "-----END CERTIFICATE-----");
		super.addPEMCertificate("IPS CLASEA1 root", // X500 Subject, for lookups.
		...
		super.addPEMCertificate("IPS CLASEA3 root", // X500 Subject, for lookups.
			"MIIBFDELMAkGA1UEBhMCRVMxEjAQBgNVBAgTCUJhcmNlbG9uYTESMBAGA1UEBxMJQmFyY2Vsb25h"
			+ "MS4wLAYDVQQKEyVJUFMgSW50ZXJuZXQgcHVibGlzaGluZyBTZXJ2aWNlcyBzLmwuMSswKQYDVQQK"
			+ "FCJpcHNAbWFpbC5pcHMuZXMgQy5JLkYuICBCLTYwOTI5NDUyMS8wLQYDVQQLEyZJUFMgQ0EgQ0xB"
		...
		super.addPEMCertificate("IPS Servidores root", // X500 Subject, for lookups.
		...
		super.addPEMCertificate("IPS Timestamping root", // X500 Subject, for lookups.
			...
			+ "-----END CERTIFICATE-----");
		super.addPEMCertificate("QuoVadis Root CA", // X500 Subject, for lookups.
			...
			+ "-----END CERTIFICATE-----");
		super.addPEMCertificate("QuoVadis Root CA 2", // X500 Subject, for lookups.
		...
		super.addPEMCertificate("QuoVadis Root CA 3", // X500 Subject, for lookups.
			"MEUxCzAJBgNVBAYTAkJNMRkwFwYDVQQKExBRdW9WYWRpcyBMaW1pdGVkMRswGQYDVQQDExJRdW9W"
			+ "YWRpcyBSb290IENBIDM=",
			"-----BEGIN CERTIFICATE-----\n"
		...
		super.addPEMCertificate("Security Communication Root CA", // X500 Subject, for lookups.
			...
			+ "-----END CERTIFICATE-----");
		super.addPEMCertificate("Sonera Class 1 Root CA", // X500 Subject, for lookups.
		...
		super.addPEMCertificate("Sonera Class 2 Root CA", // X500 Subject, for lookups.
		...
		super.addPEMCertificate("Staat der Nederlanden Root CA", // X500 Subject, for lookups.
			...
			+ "-----END CERTIFICATE-----");
		super.addPEMCertificate("TDC Internet Root CA", // X500 Subject, for lookups.
		...
		super.addPEMCertificate("TDC OCES Root CA", // X500 Subject, for lookups.
			...
			+ "BKNDLdr8C2LqL19iUw==\n" + "-----END CERTIFICATE-----");
		super.addPEMCertificate("UTN DATACorp SGC Root CA", // X500 Subject, for lookups.
		...
		super.addPEMCertificate("UTN USERFirst Email Root CA", // X500 Subject, for lookups.
			...
			"-----END CERTIFICATE-----");
		super.addPEMCertificate("UTN USERFirst Hardware Root CA", // X500 Subject, for lookups.
			...
			+ "-----END CERTIFICATE-----");
		super.addPEMCertificate("UTN USERFirst Object Root CA", // X500 Subject, for lookups.
		...
		super.addPEMCertificate("Camerfirma Global Chambersign Root", // X500 Subject, for lookups.
		...
		super.addPEMCertificate("NetLock Qualified (Class QA) Root", // X500 Subject, for lookups.
		...
		super.addPEMCertificate("NetLock Notary (Class A) Root", // X500 Subject, for lookups.
		...
		super.addPEMCertificate("NetLock Business (Class B) Root", // X500 Subject, for lookups.
		...
		super.addPEMCertificate("NetLock Express (Class C) Root", // X500 Subject, for lookups.
		...
		super.addPEMCertificate("XRamp Global CA Root", // X500 Subject, for lookups.
		...
		super.addPEMCertificate("Go Daddy Class 2 CA", // X500 Subject, for lookups.
		...
		super.addPEMCertificate("Starfield Class 2 CA", // X500 Subject, for lookups.
		...
		super.addPEMCertificate("StartCom Ltd.", // X500 Subject, for lookups.
			...
			+ "cCOxgN8aIDjnfg==\n" + "-----END CERTIFICATE-----");
		super.addPEMCertificate("StartCom Certification Authority", // X500 Subject, for lookups.
		...
		super.addPEMCertificate("Taiwan GRCA", // X500 Subject, for lookups.
			...
			+ "-----END CERTIFICATE-----");
		super.addPEMCertificate("Firmaprofesional Root CA", // X500 Subject, for lookups.
			...
			+ "quGnM/b9Sh/22WA=\n" + "-----END CERTIFICATE-----");
		super.addPEMCertificate("Wells Fargo Root CA", // X500 Subject, for lookups.
			...
			+ "-----END CERTIFICATE-----");
		super.addPEMCertificate("Swisscom Root CA 1", // X500 Subject, for lookups.
			...
			+ "MBr1mmz0DlP5OlvRHA==\n" + "-----END CERTIFICATE-----");
		super.addPEMCertificate("DigiCert Assured ID Root CA", // X500 Subject, for lookups.
			...
			+ "-----END CERTIFICATE-----");
		super.addPEMCertificate("DigiCert Global Root CA", // X500 Subject, for lookups.
		...
		super.addPEMCertificate("DigiCert High Assurance EV Root CA", // X500 Subject, for lookups.
			...
			+ "+OkuE6N36B9K\n" + "-----END CERTIFICATE-----");
		super.addPEMCertificate("Certplus Class 2 Primary CA", // X500 Subject, for lookups.
			...
			+ "-----END CERTIFICATE-----");
		super.addPEMCertificate("DST Root CA X3", // X500 Subject, for lookups.
		...
		super.addPEMCertificate("DST ACES CA X6", // X500 Subject, for lookups.
		...
		super.addPEMCertificate("SwissSign Platinum CA - G2", // X500 Subject, for lookups.
			...
			"-----END CERTIFICATE-----");
		super.addPEMCertificate("SwissSign Gold CA - G2", // X500 Subject, for lookups.
		...
		super.addPEMCertificate("SwissSign Silver CA - G2", // X500 Subject, for lookups.
	...
	override public function addPEMCertificate(name : String, subject : String,
			pem : String) : Void {
